...
export async function projectsRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/api/projects/:id', { preHandler: authenticate }, async (request, reply) => {
    ...
    try {
      ...
      const project = await projectService.getProjectById(id, req.userSession.userId);
  ...
  fastify.post('/api/projects/:id/finish', { preHandler: authenticate }, async (request, reply) => {
    ...
    try {
      ...
      // Get project data
      const projectData = await projectService.finishProject(id, req.userSession.userId);
